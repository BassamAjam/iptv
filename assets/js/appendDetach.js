function detachAll(){
  $( ".m3u, .macAddress-app, .macAddress-mag, .macAddress-tv, .otherDevice" ).detach();
}
...
$(document).ready(function(){
  $("select.device").change(function(){
    ...
    if(selectedDevice === "Android Box" || selectedDevice === "Fire Stick") {
      ...
      `);
    } else if(selectedDevice === "Android (Phone/Tablet)" ||
              selectedDevice === "All Apple devices" ) {
      detachAll();
      $('#mac-m3u').append(`
      <div class="m3u">
          ...
          <div class="switch-wrap d-flex justify-content-between">
            ...
            <div class="switch-wrap d-flex justify-content-between">
              ...
              <div class="primary-switch" data-for="account">
                <input data-form-field="Account" type="checkbox" id="primary-switch">
      ...
      `);
    } else if(selectedDevice === "Windows PC"){
      detachAll();
      $('#mac-m3u').append(`
      <div class="m3u">
        <h3 class="mb-30">Streaming Line</h3>
